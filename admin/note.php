	...
	<section id="content">
		...
		<main>
			...
			<div class="main">
				...
				<form action="NoteRech.php" method="post" class="form_rech">
					<?php
						// Liste des Matières et Classes
									...
									$rs = mysqli_query($conn, $sql) or die(mysqli_connect_error());
										...
										<div class="tabble_coprs">
											<tr>
												...
												<td class="md-2 mt-2"><input type="number" name="note1" value="<?php echo($note1)?>"></td>
												<td class="md-2 mt-2"><input type="number" name="note2" value="<?php echo($note2)?>"></td>
												<td class="md-2 mt-2"><?php echo($pond)?></td>
											</tr>
										</div>
									<?php }
								?>
